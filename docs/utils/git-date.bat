...
:main
    ...
    call :updBranch "2021-07-05 22:45:00" "2021-07-05 23:55:00"
        if errorlevel 1 (goto :failed)

    rem call :updLastCommit "2021-06-08 14:52:00"
        if errorlevel 1 (goto :failed)

    rem call :updCommit "2021-06-08 22:50:00" "9d1598fb8d73bb06c0afb329ec36e0794d9290df"
        if errorlevel 1 (goto :failed)
